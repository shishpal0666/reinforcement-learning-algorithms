...
def get_args():
    ...
    parse.add_argument('--env-name', type=str, default='PongNoFrameskip-v4', help='the environment name')  # Changed to BreakoutNoFrameskip-v4
    ...
    parse.add.argument('--target-network-update-freq', type=int, default=1000, help='the frequency to update the target network')
    parse.add.argument('--save-dir', type=str, default='saved_models/', help='the folder to save models')
    parse.add.argument('--display-interval', type=int, default=10, help='the display interval')
    parse.add.argument('--env-type', type=str, default='atari', help='the environment type')
    parse.add.argument('--log-dir', type=str, default='logs', help='dir to save log information')
    parse.add.argument('--use-double-net', action='store_true', help='use double dqn to train the agent')
    parse.add.argument('--use-dueling', action='store_true', help='use dueling to train the agent')
